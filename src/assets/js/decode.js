/**
 * 解密：使用decode.getData(str)
 * 加密：使用decode.encryptData(str)
 */
var decode = (function() {
  var KEY = '6T6yGmGhCuMG75NHMdBw9077'
  var getData = function(message) {
    return DES3.decrypt(KEY, message)
  }

  var encryptData = function(message) {
    return DES3.encrypt(KEY, message)
  }
  ...
  var DES3 = {
    ...
    encrypt: function(key, input) {
      ...
      return base64encode(des(genKey.key, input, 1, 1, des3iv, 1))
    },
